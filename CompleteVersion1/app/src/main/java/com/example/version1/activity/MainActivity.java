...
//        current_task.setText("시도정보 불러오는중...");
        ...
        doAndSiarray.add(new DoAndSi("대전", 36.342518, 127.395548, 8, R.drawable.djeon));
        doAndSiarray.add(new DoAndSi("전북", 35.594455, 127.170825, 9, R.drawable.jbuk));
        doAndSiarray.add(new DoAndSi("전남", 34.929944, 127.001457, 9, R.drawable.jnam));
        doAndSiarray.add(new DoAndSi("광주", 35.145689, 126.839936, 8, R.drawable.gwju));
        doAndSiarray.add(new DoAndSi("경북", 36.511197, 128.705964, 9, R.drawable.gbuk));
        doAndSiarray.add(new DoAndSi("경남", 35.487832, 128.485218, 9, R.drawable.gnam));
        doAndSiarray.add(new DoAndSi("대구", 35.829030, 128.558030, 8, R.drawable.dgu));
        doAndSiarray.add(new DoAndSi("울산", 35.540098, 129.296991, 8, R.drawable.ulsan));
        doAndSiarray.add(new DoAndSi("부산", 35.147905, 129.034805, 8, R.drawable.busan));
        doAndSiarray.add(new DoAndSi("제주", 33.378994, 126.521648, 9, R.drawable.jeju));
